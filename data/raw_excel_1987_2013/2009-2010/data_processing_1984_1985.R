...
#importing data
##########################################
raw_data  <- read.csv("Z:/Fisherman diary/Full excel/1984-1985/1984-5_Rennanel _corrected1.csv")
...
effort<-data.frame(raw_data$Net,effort_per_hour_per_net,raw_data$season,raw_data$dayOrNight,raw_data$Fishermen,depth,total_boxes_per_net,raw_data$draging.time,raw_data$Year.XXXX.)
