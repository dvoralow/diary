...
```{r}
long_data = read.csv("pross size 1976_2013/kg_data_sizes.csv") 
#I am here!
...
#replace the "kg" in the colnames of the species - agian, no need if there is no kg in the name
 ...
 wide_data = wide_data %>%  rename_at(vars(common_names), ~ code_vector_unique)
  ...
  write.csv(wide_data, "pross size 1976_2013/wide_new_data.CSV")
  wide_data = read.csv("pross size 1976_2013/wide_new_data.CSV")
