...
#uploud the data
raw_data_1976_2013 <- read.csv("~/diary/data/raw_data_1976_2013.csv")
...
#create vector contain the species names
 species_vector =   colnames(dplyr :: select(data,Anshubi:Daorim,-(Missing), -(Comments), -(Very_weak),-(Fishing_field_text),-(Speed), -(Net_Type), -(night), -(Night_darg), -(Dragging_time_comments), -(Night_drag), -(night_drag_prawn), -(Night_drag_comments)))
