...
loc_data[!is.na(loc_data$depth_meter),"depth_specifyed"]=T
#for nets with distance
loc_data$distance_specifyed=rep(NA,nrow(loc_data))
loc_data[!is.na(loc_data$distance_from_shore_m),"distance_specifyed"]=T
#for nets with starting position
loc_data$location_specifyed=rep(NA,nrow(loc_data))
loc_data[!is.na(loc_data$new_site),"location_specifyed"]=T
...
for (r in 1:nrow(loc_data)){
  ...
  if (!is.na(row_c$lat_shore) & !is.na(row_c$depth_meter)){
    final_loc=location_depth_based(loc_data[r,"lon_shore"],loc_data[r,"lat_shore"],loc_data[r,"perpendicular"],loc_data[r,"depth_meter"])
...
for (r in 1:nrow(loc_data)){
  ...
  if (!is.na(row_c$lat_shore) & is.na(row_c$depth_meter) & !is.na(row_c$distance_from_shore_m)){
    final_loc=location_distance_based(loc_data[r,"lon_shore"],loc_data[r,"lat_shore"],loc_data[r,"perpendicular"],loc_data[r,"distance_from_shore_m"])
    loc_data[r,"Lon_final"]=final_loc[1,"lon_final"]
    loc_data[r,"Lat_final"]=final_loc[1,"lat_final"]
  }else{}
}
