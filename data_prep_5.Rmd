...
because some of the functoins take time, a lot of exel file exported to the folder "prosseced data", for easy started in any part of the code.
...
write.csv(loc_data, "prosseced data/final_data_2013_2018.CSV")
loc_data = read.csv("prosseced data/final_data_2013_2018.CSV")

itay_data = read.csv("prosseced data/final_data_1987_2013.CSV")



itay_col = colnames(itay_data)
dvora_col = colnames(loc_data)
itay_col = c(itay_col,c(rep(NA,10)))
