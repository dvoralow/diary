...
write.csv(loc_data, "prosseced data/wide_location_temporarty.CSV")
  loc_data = read.csv("prosseced data/wide_location_temporarty.CSV")
...
write.csv(loc_data, "prosseced data/wide_data_1.CSV")
  loc_data = read.csv("prosseced data/wide_data_1.CSV")
