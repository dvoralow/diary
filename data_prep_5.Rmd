...
```{r}
#upload the data my data
raw_data <- read.csv(file="data/all_data_2013_2018.csv", stringsAsFactors=FALSE)
#aploud Itay data
raw_data <- read.csv(file="data/raw_data_1976_2013.csv", stringsAsFactors=FALSE)
...
write.csv(kg_data, "prosseced data/kg_data_sizes.CSV")
  wide_data = read.csv("prosseced data/kg_data_sizes.CSV")
...
write.csv(all_data, "prosseced data/final_data_1987_2018.CSV")
